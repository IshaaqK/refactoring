...
public class StatementPrinter {
    ...
    public String statement() {
        ...
        for (Performance p : invoice.getPerformances()) {
            final String playType = getPlay(p).getType();

            volumeCredits += getVolumeCredits(p, playType);
    ...
    private static int getVolumeCredits(Performance performance, String playType) {
        int result = 0;
        // add volume credits
